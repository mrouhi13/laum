...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('setting', models.CharField(choices=[('site_slogan_1', 'Site Slogan 1'), ('site_slogan_2', 'Site Slogan 2'), ('default_keywords', 'Default Keywords'), ('default_description', 'Default Description'), ('contact_email', 'Contact Email'), ('notification_email', 'Notification Email'), ('google_analytics_id', 'Google Analytics ID')], help_text='Each setting can only be used once.', max_length=32, unique=True, verbose_name='setting')),
                ('content', models.CharField(help_text='The content displayed on the site.', max_length=1024, verbose_name='content')),
            ],
            options={
