# Generated by Django 2.2.6 on 2019-12-29 10:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('en', 'English'), ('fa', 'Persian')], db_index=True, default=web.helpers.get_active_lang, max_length=7, verbose_name='language')),
                ('updated_on', models.DateTimeField(auto_now=True, verbose_name='updated on')),
                ('created_on', models.DateTimeField(auto_now_add=True, verbose_name='created on')),
                ...
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pages', to='web.Group', verbose_name='group')),
            ],
            options={
                'verbose_name': 'page',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, help_text='Designate whether pages related to this tag can include in the result list.', verbose_name='active status')),
            ],
            options={
                'verbose_name': 'tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(auto_now=True, verbose_name='updated on')),
                ('created_on', models.DateTimeField(auto_now_add=True, verbose_name='created on')),
                ('rid', models.CharField(editable=False, max_length=32, null=True, unique=True, verbose_name='reference ID')),
                ...
                ('description', models.TextField(blank=True, help_text='A description if need to remember in the future. Also, if the report is denied, the content of this field will be sent to the user.', max_length=1024, verbose_name='description')),
